    ...
    return (
        <div className="bg-neutral-300 flex justify-center items-center h-screen">
         ...
         focus:ring-blue-500 focus:border-blue-500" type="password" placeholder="Senha" />
                ...
                <a className=" w-full justify-center flex" href="./homeAdm.html" >
                ...
                <div className="flex w-3/4 h-10">
                    <p className="mr-1 text-sm">Ainda não possui uma conta?</p><a className="text-blue-700 text-sm" href="./index.html">Cadastre-se</a>
                </div>
